...
export default function LessonsPage({ router: { query } }: PageProps) {
  ...
  return (
    <>
      <LessonLayoutHeader
        ...
        onCreateLessonClick={() =>
          createNewLessonDialogRef.current!.showModal()
        }
      />
        ...
        createPortal(
          ...
          >
            ...
            <p className="mt-1 text-sm text-stone-700">
              This action is irreversible when initiated. All topics under this

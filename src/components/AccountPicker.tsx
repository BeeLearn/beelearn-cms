...
export default function AccountPicker({ user, className }: AccountPickerProps) {
    ...
    return (
        <div className={join("flex items-center space-x-2 border px-2 py-0.5 rounded-full cursor-pointer at:md:p-0 at-md:border-0 ", className)}>
            <div>
                <Image 
            ...
            <div className="flex-1 flex flex-col at-md:hidden">
